...
},{"./lib/linkify-html":6}],5:[function(require,module,exports){
module.exports = require('./lib/linkify');

},{"./lib/linkify":7}],6:[function(require,module,exports){
'use strict';
...
},{"./linkify":7,"./simple-html-tokenizer":17}],7:[function(require,module,exports){
'use strict';
...
},{"./linkify/core/parser":8,"./linkify/core/scanner":9,"./linkify/utils/class":15,"./linkify/utils/options":16}],8:[function(require,module,exports){
'use strict';
...
},{"../utils/class":15}],11:[function(require,module,exports){
"use strict";
...
exports.TEXT = TEXT;
exports.URL = URL;
},{"../../utils/class":15,"./create-token-class":11,"./text":13}],13:[function(require,module,exports){
'use strict';
...
},{"../../utils/class":15,"./create-token-class":11}],14:[function(require,module,exports){
'use strict';
...
},{"./simple-html-tokenizer/entity-parser":18,"./simple-html-tokenizer/evented-tokenizer":19,"./simple-html-tokenizer/html5-named-char-refs":20,"./simple-html-tokenizer/tokenize":21,"./simple-html-tokenizer/tokenizer":22}],18:[function(require,module,exports){
"use strict";
...
},{"./entity-parser":18,"./html5-named-char-refs":20,"./tokenizer":22}],22:[function(require,module,exports){
'use strict';
...
},{"./evented-tokenizer":19}],23:[function(require,module,exports){
"use strict";
...
},{"../lib/linkify/plugins/hashtag":14}],25:[function(require,module,exports){
...
},{"autosize":1}],27:[function(require,module,exports){
var Vue // late bind
...
},{"_process":25}],30:[function(require,module,exports){
'use strict';
...
var _hashtag = require('linkifyjs/plugins/hashtag');
...
var _vueFilters = require('./vue-components/vueFilters.js');
...
;
// optional
window.linkifyHtml = _html2.default;
window.hashtag = _hashtag2.default;
(0, _hashtag2.default)(linkify);
...
(function (document) {
	...
	window.Element.prototype.flatpickr = function (config) {
		return (0, _flatpickr2.default)(this, config);
	};
	window.Element.prototype.flatpickrify = function (config) {
		return (0, _flatpickr2.default)(this, {
...
(0, _jquery2.default)(window).on("scroll", function (e) {
	...
	// let el = $('.navigation');
	if (!(0, _globalFunctions.isElementInViewport)(el[0])) {
		(0, _jquery2.default)("body").addClass("scrolled-down");
	} else {
...
window.setRowHeight = function () {
	...
	(0, _jquery2.default)('textarea[name=item_body]').each(function (index) {
		var x = (0, _jquery2.default)(this).parent().parent().find('.bodybox').height();
		(0, _jquery2.default)(this).height(x);
	});
};
...
_jquery2.default.getJSON('/api/items', function (fetchedData) {
	...
	//response
	setTimeout(function () {
		var flatpickrInputs = document.getElementsByClassName("flatpickr");
    ...
    */
			...
			filterItems: function filterItems(keyword, value, operator) {
				if (!operator) {
					selection.tags = [];
					selection.filter = [];
				}
				...
				if (keyword == 'done') {
					if (selection.filter.includes('done')) {
						return;
					}
...
exports.default = {
	...
	computed: {
		...
		showAddNewBoxFirstChild: function showAddNewBoxFirstChild() {
		...
		totalTimeLeft: function totalTimeLeft() {
			var x = this.item.totalPlannedTime * 60 - this.item.totalUsedTime;
			return x;
		},
		timeLeft: function timeLeft() {
			var x = this.item.planned_time * 60 - this.item.used_time;
			return x;
		},
	...
	methods: {
		...
		keydownOnNew: function keydownOnNew(item, e, field) {
			...
			if (e.keyCode === 38) {
				...
				if (field == 'planned-time') {
					e.preventDefault();
					var _plsFocus = '.addnewbox .newitem-body';
			...
			if (e.keyCode === 40) {
				...
				if (field == 'body' && !this.newItem.body) {
					e.preventDefault();
					var _plsFocus3 = '.addnewbox .update-planned-time>button';
					document.querySelector(_plsFocus3).focus();
					return;
				}
				if (field == 'planned-time') {
					e.preventDefault();
					var _plsFocus4 = '.addnewbox .prepare-tag';
		...
		keydownOnEdit: function keydownOnEdit(item, e, field) {
			...
			if (e.keyCode === 13 && !e.shiftKey && !e.altKey) {
				if (field == 'planned-time') {
					if (e.srcElement.nodeName == 'INPUT') {
						e.preventDefault();
						var plsFocus = '#updatebox-' + item.id + ' .add-tag';
						document.querySelector(plsFocus).focus();
						if (!this.item.planned_time) {
							this.item.planned_time = 0;
						}
			...
			if (e.keyCode === 38) {
				...
				if (field == 'planned-time') {
					e.preventDefault();
					var _plsFocus5 = '#updatebox-' + item.id + ' .edititem-body';
					document.querySelector(_plsFocus5).focus();
					return;
				}
				if (field == 'addTag') {
					e.preventDefault();
					var _plsFocus6 = '#updatebox-' + item.id + ' .update-planned-time>button';
					document.querySelector(_plsFocus6).focus();
					return;
				}
			}
			// ArrowDown
			if (e.keyCode === 40) {
				...
				if (field == 'planned-time') {
					e.preventDefault();
					var _plsFocus7 = '#updatebox-' + item.id + ' .add-tag';
					document.querySelector(_plsFocus7).focus();
					return;
				}
				if (field == 'addTag') {
					e.preventDefault();
		...
		setPlannedTime: function setPlannedTime(item, time, event) {
			var plsFocus = '#updatebox-' + item.id + ' .add-tag';
			setTimeout(function () {
		...
		setPlannedTimeNewItem: function setPlannedTimeNewItem(item, time, event) {
			var plsFocus = ".addnewbox .prepare-tag";
			// let plsFocus;
			// if(this.showAddNewBox == true){ plsFocus = "#new-under-"+item.id+" .prepare-tag"; }
			// if(this.showAddNewBoxFirstChild == true){ plsFocus = "#new-firstchild-of-"+item.id+" .prepare-tag"; }
	...
	events: {
		...
		escapeOnEditButtonFocus: function escapeOnEditButtonFocus() {
			this.cancelEdit();
		},
...
var Tree = function () {
	...
	_createClass(Tree, [{
		...
		key: 'nextFilteredItemId',
		value: function nextFilteredItemId(id) {
			var index = this.root.children_order.indexOf(id);
			return this.root.children_order[index + 1];
		}
	}, {
		key: 'prevFilteredItemId',
		value: function prevFilteredItemId(id) {
			var index = this.root.children_order.indexOf(id);
			return this.root.children_order[index - 1];
		}
	}, {
		...
		value: function sortChildren(id) {
			...
			item.children_order = item.children_order.filter(function (id) {
				return ~item.children.indexOf(_this.nodes[id]);
			});
		...
		key: 'resetChildrenOrder',
		value: function resetChildrenOrder(id) {
			var item = this.nodes[id];
			var resetChildrenOrder = item.children.map(function (child) {
				return child.id;
			});
		...
		value: function filterItems(keyword, value, operator) {
			...
			if (keyword == 'tag') {
				(function () {
					var filteredTag = value;
					Object.keys(_this4.nodes).forEach(function (key) {
						var item = this.nodes[key];
						var hasTag = item.tagged.find(function (actualTags) {
							return actualTags.tag_slug == filteredTag;
						});
						if (hasTag) {
							item.show_children = 1;
							this.filteredItemRoot.children.push(item);
		...
		value: function formatDone(doneArray) {
			...
			return Object.keys(doneItemsObject).map(function (k) {
				...
				rObj['totalTime'] = rObj['items'].reduce(function (prev, next) {
