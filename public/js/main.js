...
exports.default = {
	...
	methods: {
		...
		enterOnAddTag: function enterOnAddTag(item, tag, event) {
		...
		addTag: function addTag(item, tag) {
...
var Tree = function () {
	...
	_createClass(Tree, [{
		...
		key: 'addItem',
		value: function addItem(item, index, addNextItemAs) {
