...
export default {
	...
	mounted(){
      ...
      window.addEventListener('keydown', function(e) {
		...
		else if ( document.querySelector('input:focus').length > 0
        	||  document.querySelector('textarea:focus').length > 0
        	|| document.querySelector('a:focus').length > 0
        	|| document.querySelector('button:focus').length > 0)
		{
        	return;
		}
		else
